        ...
        <div id="container">
			...
			<div id="resumeBody">
				...
				<div id="information" style="display: none;">
					...
					<form class="form-inline" id="infoForm">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <span class="bianqian">*</span><label for="jobIntension">兼职意向：</label>
                    ...
                    <!--上传照片-->
			        <div class="touxiang">
			  			<img src="${contextPath}/static/img/logo.png" alt="..." id="photoImg" class="img-thumbnail" width="140px" height="140px"/>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				  <form enctype="multipart/form-data" id="modelForm" method="post">
					  <input id="input-b2" name="filename" accept="application/pdf"  type="file" class="file" data-show-preview="false">
					  <div class="row">
