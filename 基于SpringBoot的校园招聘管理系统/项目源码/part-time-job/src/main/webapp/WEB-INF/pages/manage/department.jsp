		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalAdd">新增企业</h4>
		      </div>
		      <div class="modal-body">
		        <form>
					  <div class="form-group">
					    <label for="question">企业名称：</label>
					    <input type="text" class="form-control" id="addPName" placeholder="输入企业名称">
					  </div>
				</form>
		      </div>
