	...
	<nav class="navbar navbar-default">
        ...
        <div id="container">
        	<div class="text1">
        		...
        		<span style="display: inline-block;float: right;"><a href="javaScript:void(0)" onclick="history.back();">返回兼职列表</a></span>
        	...
        	<div class="btn-group">
        		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">申请兼职</button>
        		&nbsp;&nbsp;
        		<button type="button" class="btn btn-info" id="collectBtn">收藏兼职</button>
