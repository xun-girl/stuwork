l<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                    ...
                    <div id="sidebar-scroll">
                        <div class="sidebar-content">
							<ul class="sidebar-nav">
								...
								<li>
									<a href="/admin//position"><i class="icon-chevron-right sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="icon-gift sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">兼职管理</span></a>
								...
								<li>
									<a href="/admin/department" ><i
											class="icon-chevron-right sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="icon-gift sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">企业管理</span></a>

								</li>
								<li>
									<a href="/admin/job" ><i
											class="icon-chevron-right sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="icon-gift sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">兼职类别管理</span></a>

								</li>
								<li>
									<a href="/admin/apply" ><i
											class="icon-chevron-right sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="icon-gift sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">兼职申请进度管理</span></a>
						...
						<div>
							...
							<form class="form-inline" style="float: left;">
								...
								<div class="form-group">
									<input type="text" class="form-control" id="exampleInputName2" placeholder="输入相应的兼职的名称">
								</div>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalAdd">新增兼职</h4>
		      </div>
		      <div class="modal-body">
		        <form>
					  <div class="form-group">
					    <label for="question">兼职名称：</label>
					    <input type="text" class="form-control" id="addPName" placeholder="输入兼职名称">
					  </div>
					<div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <select class="form-group" id="addFlag">
					    	<option value="2">校园兼职</option>
					    	<option value="1">社会兼职</option>
					    </select>
					  </div>
					  <div class="form-group">
...
<%--					        <option>管理</option>--%>
					...
					<div class="form-group">
						<label for="exampleInputFile">企业：</label>
		 ...
		 <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="myModalLabel">兼职详情</h4>
		      </div>
		      <div class="modal-body">
		        <form>
					  <div class="form-group">
