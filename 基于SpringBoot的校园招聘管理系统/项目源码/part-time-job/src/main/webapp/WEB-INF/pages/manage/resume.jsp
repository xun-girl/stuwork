	...
	<body>
		...
		<div id="container">
			...
			<div id="personInfo">
				...
				<label for="intension" class="intension">兼职意向：</label><span>${resume.informationDto.jobIntension}</span><br />
			...
			<div id="image">
				<img src="<%=request.getContextPath()%>/${resume.informationDto.photo}" width="150" height="150">
			<div>
		</div>
	</body>
</html>
